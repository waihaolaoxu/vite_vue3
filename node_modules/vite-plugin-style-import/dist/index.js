...
var changeCase = __toModule(require("change-case"));
...
function resolveNodeModules(libName, ...dir) {
  const modulePath = (0, import_vite.normalizePath)(require.resolve(libName));
...
// src/index.ts
var debug = (0, import_debug.default)("vite-plugin-style-import");
